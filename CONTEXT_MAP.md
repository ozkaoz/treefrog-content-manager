...
- Content Manager tests: `treefrog-manager/tests/` (131 tests: 94 + 24 LGPT + 13 BIOS-B) + `tests/test_content_manager_*.py` (fixtures for archives/duplicates/media/BIOS/LGPT/video, now with `tests/fixtures/lgpt/samples` + `projects/ProjectA`/`ProjectB` synthetic WAVs)
