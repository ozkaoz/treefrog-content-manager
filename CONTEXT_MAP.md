...
- Content Manager app: `treefrog-manager/` (Tauri 2 + Rust backend + React TS frontend + SQLite; Phase 2B duplicate/conflict resolution, planner single source of truth)
- Content Manager tests: `treefrog-manager/tests/` (66 tests: 53 + 13 Phase 2B) + `tests/test_content_manager_*.py` (fixtures for archives/duplicates/media/BIOS/LGPT/video)
- Content Manager docs: `docs/PLAN.md` (phases 0-7, now 1.1.0 Phase 2B), `docs/ARCHITECTURE.md` (archive abstraction, safety, profile-driven, planner single source)
